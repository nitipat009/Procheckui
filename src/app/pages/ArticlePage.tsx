...
function ShareButtons({
  ...
  const btn =
    "inline-flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 bg-white text-gray-600 hover:text-[#550000] hover:border-[#550000] transition-colors";
    ...
    return (
      <div className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-20 text-center">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#550000] text-white hover:bg-[#3D0000] transition-colors"
          >
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        {loading || !article ? (
          ...
          <>
            ...
            <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-6 flex-wrap">
              <Link to="/" className="hover:text-[#550000]">
                ข่าวสาร
              </Link>
                  ...
                  <div className="flex items-center gap-2 flex-wrap mt-10 pt-6 border-t border-gray-100">
                    ...
                    {article.tags.map((t) => (
                      <Link
                        ...
                        className="text-xs px-3 py-1 rounded-full bg-gray-100 text-gray-700 hover:bg-[#550000] hover:text-white transition-colors"
                      >
                        {t}
                      </Link>
                    ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                    {prev ? (
                      <Link
                        ...
                        className="group rounded-xl border border-gray-200 p-4 hover:border-[#550000] hover:shadow-sm transition-all"
                      >
                        <div className="text-xs text-gray-500 inline-flex items-center gap-1 mb-1">
                          <ChevronLeft className="w-3 h-3" /> บทความก่อนหน้า
                        </div>
                        <div className="text-sm text-gray-900 group-hover:text-[#550000] line-clamp-2">
                          {prev.title}
                        </div>
                      </Link>
                    ) : (
                    ...
                    {next ? (
                      <Link
                        ...
                        className="group rounded-xl border border-gray-200 p-4 hover:border-[#550000] hover:shadow-sm transition-all md:text-right"
                      >
                        ...
                        <li key={r.id}>
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
                              <h3 className="text-sm text-gray-900 line-clamp-2 group-hover:text-[#550000]">
                                {r.title}
                              </h3>
      ...
      <style>{`
        ...
        .article-body blockquote { border-left: 3px solid #550000; background: #F5F7FA; padding: 0.75rem 1rem; margin: 1.25rem 0; color: #374151; border-radius: 0 8px 8px 0; }
        .article-body a { color: #550000; text-decoration: underline; text-underline-offset: 2px; }
