...
// ── Slider ───────────────────────────────────────────────────────────────────
function Slider({ label, min, max, value, unit, onChange, accentColor = "#550000" }: {
...
// ── Dual Price Slider ────────────────────────────────────────────────────────
function PriceSlider({ min: minVal, max: maxVal, onChange, accentColor = "#550000" }: {
...
export function FilterPanel({ type, initialValues, onApply }: Props) {
  ...
  const accentColor = isMobile ? "#550000" : "#550000";
