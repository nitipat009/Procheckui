    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none px-3 py-2.5 rounded-xl border border-gray-200 bg-white hover:border-[#550000] text-sm text-gray-700 focus:outline-none focus:border-[#550000] transition-colors cursor-pointer pr-8"
        >
...
const privileges = [
  ...
  { Icon: Trophy,          label: "กีฬา",     color: "#550000", bg: "#EBF2FF" },
  ...
  return (
    <section className="relative overflow-hidden pt-2 pb-2 md:pt-5 md:pb-5">
      ...
      <div className="relative mx-auto px-4 md:px-6">
        ...
        {/* Search Card */}
        <div className="bg-white rounded-2xl shadow-[0_4px_16px_-4px_rgba(0,0,0,0.20)] border border-white/10 p-4 md:p-8">
          ...
          <button
            ...
            className="mt-5 md:mt-6 w-full bg-[#550000] hover:bg-[#3D0000] text-white py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition-colors shadow-[0_6px_20px_-8px_rgba(11,94,215,0.6)]">
